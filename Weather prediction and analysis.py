...
st.markdown("""
    <style>
        ...
        /* Sidebar text (navigation menu) - white text */
        ...
        /* Regular text (paragraphs, widgets) */
        .stText, .stMarkdown, .stRadio, .stSelectbox, .stButton, .stMetric, .stWrite {
        ...
        .stRadio > div, .stSelectbox {
            color: black;  /* Text color for radio and selectbox options */
        }

        /* Text Input fields */
        .stTextInput, .stNumberInput, .stTextArea {
            color: black;  /* Text color for text input fields */
            background-color: #f0f0f0;  /* Light grey background for input fields */
        }

        /* Adjusting other UI elements like sliders, etc. */
        .stSlider .st-bw {
            color: black;  /* Slider text color */
        }

        .stCheckbox, .stCheckbox > div {
            color: black;  /* Text color for checkboxes */
        }

        /* Ensure predicted values (metrics and other output) are in black */
        .stMetric div, .stText div, .stWrite div {
            color: black;  /* Set color for predictions/results */
        }
    </style>
